...
def main():
    ...
    parser.add_argument("--sac-config", type=str, default="configs/sac_stage1.yaml")
    ...
    train_env, eval_env = build_envs(env_cfg, stage="reach")
    ...
    if args.resume:
        ...
        model = SAC("MlpPolicy", train_env, **model_kwargs)

    checkpoint_callback = CheckpointCallback(
        save_freq=sac_cfg["checkpoint_freq"],
        save_path=checkpoints_dir,
        name_prefix="stage1_reach",
    )
